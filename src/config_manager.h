...
class ConfigManager{
    ...
    public:
        ...
        // Ground-level deployment functions
        LoraParams getGroundLevelConfig(float range, float height_m);
        float calculateGroundRange(const LoraParams& params, float height_m, bool isChipAntenna);
};